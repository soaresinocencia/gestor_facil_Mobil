import flet as ft
from src.mobile.views.login_view import LoginView
from src.mobile.views.dashboard_view import DashboardView
from src.mobile.views.products_view import ProductsView
from src.mobile.views.pos_view import POSView
